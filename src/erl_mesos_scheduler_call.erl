...
-spec subscribe(erl_mesos:scheduler_info(), erl_mesos_data_format:message()) ->
...
%% %% @private
%% -spec call_obj(erl_mesos_scheduler:scheduler_info(),
%%                erl_mesos_data_format:message()) ->
...
request_headers(DataFormat) ->
    [{<<"Content-Type">>, erl_mesos_data_format:content_type(DataFormat)},
     {<<"Accept">>, erl_mesos_data_format:content_type(DataFormat)},
     {<<"Connection">>, <<"close">>}].
